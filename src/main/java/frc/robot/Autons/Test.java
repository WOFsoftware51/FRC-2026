...
public class Test extends SequentialCommandGroup {
  /** Creates a new test. */
  public Test(Swerve swerve, RobotState robotState, ShooterSubsystem shooter, IntakePivotSubsystem intakePivot,IntakeSubsystem intake, FeederSubsystem feeder, SpindexerSubsystem spindexer, PivotSubsystem pivot, Superstructure superstructure) {
